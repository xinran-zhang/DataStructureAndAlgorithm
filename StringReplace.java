 ...
 * All substrings A appearing in S are replaced by B.(Notice:
 * From left to right, it must be replaced if it can be replaced.
...
// this method uses hash function and the time complexity is O(A.size() * S.length)
